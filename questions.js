...
// === NEUE KATEGORIE: Mechatroniker (Ausbildung) ===
QUESTIONS.push(
  { id: 'mech-001', topic: 'mechatroniker', difficulty: 'leicht', question: 'Wofür steht in der Automatisierungstechnik die Abkürzung SPS?', options: ['Schalt- und Prüfstation', 'Speicherprogrammierbare Steuerung', 'Servoprozess-System', 'Steckdosen-Prüfsystem'], correct_index: 1, explanation: 'SPS = Speicherprogrammierbare Steuerung. Sie ersetzt verdrahtete Relais-Steuerungen durch ein Programm im Speicher, das Eingänge auswertet und Ausgänge schaltet.', fun_fact: 'Im Englischen heißt das gleiche Gerät PLC (Programmable Logic Controller). Die erste SPS entstand 1968 in der US-Autoindustrie, weil das ständige Umverdrahten von Relais-Steuerungen bei Modellwechseln unbezahlbar wurde.' },
  { id: 'mech-002', topic: 'mechatroniker', difficulty: 'leicht', question: 'Welche Nennspannung führt das Stromnetz in deutschen Steckdosen?', options: ['110 V', '230 V', '400 V', '12 V'], correct_index: 1, explanation: 'Das deutsche Niederspannungsnetz liefert 230 V Wechselspannung mit 50 Hz Frequenz an der Schutzkontakt-Steckdose.', fun_fact: 'Bis 1987 waren es offiziell 220 V – die Erhöhung auf 230 V war eine EU-weite Harmonisierung. Geräte tolerieren ±10%, also läuft alles von 207 V bis 253 V problemlos.' },
  { id: 'mech-003', topic: 'mechatroniker', difficulty: 'leicht', question: 'Wie lautet das ohmsche Gesetz?', options: ['U = P · I', 'U = R · I', 'U = R / I', 'U = I² · R'], correct_index: 1, explanation: 'Spannung U ist gleich Widerstand R mal Stromstärke I (U = R · I). Umgestellt: I = U/R und R = U/I.', fun_fact: 'Georg Simon Ohm veröffentlichte das Gesetz 1827 – und wurde dafür von der Fachwelt zunächst verspottet. Erst Jahre später bekam er Anerkennung, und die Einheit Ohm (Ω) wurde nach ihm benannt.' },
  { id: 'mech-004', topic: 'mechatroniker', difficulty: 'leicht', question: 'Welches Werkzeug benötigt man, um eine Innensechskantschraube (Inbusschraube) zu lösen?', options: ['Schlitzschraubendreher', 'Torx-Bit', 'Inbusschlüssel', 'Ringschlüssel'], correct_index: 2, explanation: 'Ein Inbusschlüssel (auch Imbus oder Sechskant-Stiftschlüssel) ist ein L-förmiges Werkzeug mit sechseckigem Profil, das genau in den Schraubenkopf passt.', fun_fact: 'Der Name „Inbus" ist eigentlich ein Markenname und steht für „Innensechskant-Bauer & Schaurte" – die deutsche Firma, die diese Schraubenart 1936 patentieren ließ.' },
  { id: 'mech-005', topic: 'mechatroniker', difficulty: 'mittel', question: 'Was passiert mit dem Gesamtwiderstand, wenn man zwei Widerstände in Reihe schaltet?', options: ['Er wird kleiner als der kleinste Einzelwiderstand', 'Er ist die Summe der Einzelwiderstände', 'Er ist der Mittelwert beider Widerstände', 'Er bleibt gleich dem ersten Widerstand'], correct_index: 1, explanation: 'Bei Reihenschaltung addieren sich die Widerstände: R_ges = R1 + R2 + ... . Bei Parallelschaltung wird dagegen der Kehrwert addiert.', fun_fact: 'Genau umgekehrt ist es bei Kondensatoren – die addieren sich in Parallelschaltung und werden in Reihe kleiner. Ein häufiger Fallstrick in IHK-Prüfungen.' },
  { id: 'mech-006', topic: 'mechatroniker', difficulty: 'mittel', question: 'Was bedeutet das Zeichen „3~" auf dem Typenschild eines Motors?', options: ['Der Motor hat drei Wicklungen', 'Der Motor läuft mit Dreiphasen-Wechselstrom (Drehstrom)', 'Die Spannung schwankt um ±3 %', 'Der Motor hat 3 Polpaare'], correct_index: 1, explanation: '„3~" bezeichnet Dreiphasen-Wechselstrom (Drehstrom) mit drei um 120° versetzten Außenleitern. Industriestandard für Motoren ab etwa 1 kW.', fun_fact: 'Drehstrommotoren brauchen keinen Kommutator und sind dadurch fast wartungsfrei. Der erste praxistaugliche wurde 1889 von Michael Dolivo-Dobrowolsky bei der AEG in Berlin entwickelt.' },
  { id: 'mech-007', topic: 'mechatroniker', difficulty: 'mittel', question: 'Was bedeutet die Schutzart „IP65" bei einem Gehäuse?', options: ['Spritzwassergeschützt und gegen leichten Staub', 'Staubdicht und strahlwassergeschützt', 'Wasserdicht bis 65 m Tiefe', 'Erlaubt für 65 °C Umgebungstemperatur'], correct_index: 1, explanation: 'Die erste Ziffer (6) bedeutet staubdicht, die zweite Ziffer (5) heißt Schutz gegen Strahlwasser aus allen Richtungen. IP = International Protection.', fun_fact: 'Erst ab IP67 (zweite Ziffer 7) wäre zeitweiliges Eintauchen erlaubt, IP68 für dauerhaftes Untertauchen – typische Angabe bei modernen Smartphones.' },
  { id: 'mech-008', topic: 'mechatroniker', difficulty: 'mittel', question: 'Welche der „Fünf Sicherheitsregeln" beim Arbeiten an elektrischen Anlagen kommt als erste?', options: ['Gegen Wiedereinschalten sichern', 'Freischalten', 'Spannungsfreiheit feststellen', 'Erden und kurzschließen'], correct_index: 1, explanation: 'Die Reihenfolge lautet: 1. Freischalten, 2. Gegen Wiedereinschalten sichern, 3. Spannungsfreiheit feststellen, 4. Erden und kurzschließen, 5. Benachbarte unter Spannung stehende Teile abdecken oder abschranken.', fun_fact: 'Diese fünf Regeln retten Leben und sind in Deutschland in der DIN VDE 0105-100 verbindlich vorgeschrieben – fester Bestandteil jeder elektrotechnischen Abschlussprüfung.' },
  { id: 'mech-009', topic: 'mechatroniker', difficulty: 'mittel', question: 'Welcher der folgenden Werkstoffe ist NICHT ferromagnetisch?', options: ['Stahl', 'Nickel', 'Aluminium', 'Kobalt'], correct_index: 2, explanation: 'Aluminium ist nicht ferromagnetisch – anders als Eisen, Nickel und Kobalt, die die drei klassischen ferromagnetischen Metalle bei Raumtemperatur sind.', fun_fact: 'Auch viele Edelstähle (z. B. V2A/V4A) sind nicht magnetisch, obwohl sie hauptsächlich aus Eisen bestehen – das liegt am austenitischen Gefüge durch hohen Chrom- und Nickel-Anteil.' },
  { id: 'mech-010', topic: 'mechatroniker', difficulty: 'schwer', question: 'Was beschreibt die ISO-Passung „H7/g6"?', options: ['Eine Übermaßpassung (Welle größer als Bohrung)', 'Eine Spielpassung (Welle kleiner als Bohrung)', 'Eine Übergangspassung (mal Spiel, mal Übermaß)', 'Eine Festsitzverbindung mit Klebstoff'], correct_index: 1, explanation: 'H7/g6 ist die klassische Spielpassung im Maschinenbau: Die Bohrung (H7) liegt über dem Nennmaß, die Welle (g6) darunter – es bleibt immer ein kleines Spiel. Typisch für leicht bewegliche Wellen in Gleitlagern.', fun_fact: 'Der Großbuchstabe steht immer für die Bohrung, der Kleinbuchstabe für die Welle. „H" und „h" bezeichnen jeweils das Grundabmaß genau an der Nennmaß-Linie – daher Einheitsbohrung bzw. Einheitswelle.' },
  { id: 'mech-011', topic: 'mechatroniker', difficulty: 'schwer', question: 'Wie hoch ist der Scheitelwert (Spitzenwert) der deutschen Netzspannung von 230 V Effektivwert?', options: ['230 V', 'ca. 325 V', 'ca. 400 V', 'ca. 460 V'], correct_index: 1, explanation: 'Bei sinusförmigem Wechselstrom gilt: Scheitelwert = Effektivwert · √2 ≈ 1,414 · 230 V ≈ 325 V. Der Effektivwert ist der DC-äquivalente Wert für gleiche Heizleistung.', fun_fact: 'Genau wegen dieser 325-V-Spitzen müssen Kondensatoren am Netz oft für 400 V oder mehr ausgelegt sein – die Angabe „230 V" ist nur der Effektivwert, nicht der Maximalwert.' },
  { id: 'mech-012', topic: 'mechatroniker', difficulty: 'schwer', question: 'Worin unterscheidet sich ein Servomotor von einem klassischen Asynchronmotor?', options: ['Servo läuft nur mit Gleichstrom', 'Servo hat einen Positions-Rückmelder (Encoder) und wird geregelt', 'Servo ist generell stärker', 'Servo benötigt keinen Frequenzumrichter'], correct_index: 1, explanation: 'Ein Servomotor besitzt einen Geber (Encoder oder Resolver), der die aktuelle Position an die Regelung meldet. Dadurch lässt sich die Position hochgenau und dynamisch ansteuern – typisch in CNC-Maschinen und Robotik.', fun_fact: 'Der Begriff „Servo" kommt vom lateinischen „servus" (Diener) – der Motor „dient" einer Sollgröße und folgt ihr exakt. Standard-Asynchronmotoren laufen dagegen einfach „so schnell wie die Netzfrequenz es vorgibt", ohne Rückmeldung.' }
);
